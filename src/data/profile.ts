...
export const devProfile: ProfileData = {
  ...
  about: {
    bio: "I'm a passionate developer who loves creating interactive and scalable web applications. With a strong foundation in modern web technologies, I bridge the gap between design and engineering.",
    highlights: ["Interactive UI", "Systems Architecture", "Creative Coding"],
    avatar: "/me.jpg",
  },
  skills: [
    {
